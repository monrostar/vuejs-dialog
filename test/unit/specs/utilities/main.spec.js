...
import * as Utility from '../../../../src/plugin/utilities';
...
describe('Utility #cloneObj', function() {
  ...
  it(
    'The solution: cloned object should not be equal to original after altering',
    function() {
      let objA = {foo: 'abc', bar: '123'};
...
describe('Utility #firstIndex', function() {
  ...
  it('First index of yellow should be 0', function() {
    should(Utility.firstIndex(arr, 'yellow', 'color')).
    be.
    exactly(0).
    and.
    a.
  ...
  it('First index of blue should be 0', function() {
    should(Utility.firstIndex(arr, 'blue', 'color')).
    be.
    exactly(2).
    and.
    a.
  ...
  it('First index of black should be undefined', function() {
    should(Utility.firstIndex(arr, 'black', 'color')).
    be.
    exactly(-1).
    and.
    a.
